...
public class QpAnimatedGIFField extends BitmapField 
{
    private GIFEncodedImage _image;     //The image to draw.
    private int _currentFrame;          //The current frame in the animation sequence.
    private AnimatorThread _animatorThread;
    
    public QpAnimatedGIFField(GIFEncodedImage image)
    {
        this(image, 0);
    }
    
    public QpAnimatedGIFField(GIFEncodedImage image, long style)
    {
    ...
    {
        private QpAnimatedGIFField _theField;
        ...
        public AnimatorThread(QpAnimatedGIFField theField)
        {
            _theField = theField;
