...
public class QpAnimatedGIF extends BitmapField {
	private GIFEncodedImage _image; // The image to draw.
	private int _currentFrame; // The current frame in the animation sequence.
	private AnimatorThread _animatorThread;

	public QpAnimatedGIF(GIFEncodedImage image) {
		this(image, 0);
	}

	public QpAnimatedGIF(GIFEncodedImage image, long style) {
	...
	public int getSleepTime() {
		return _image.getFrameDelay(_currentFrame) * 10;
	}
	...
	private class AnimatorThread extends Thread {
		private QpAnimatedGIF _theField;
		...
		public AnimatorThread(QpAnimatedGIF theField) {
			_theField = theField;
